#!/usr/bin/env python3
"""
Single GPU Fine-tuning script for Qwen-3 8B model
Optimized for advertising copy generation
"""
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="./qwen_advertising_copy",
